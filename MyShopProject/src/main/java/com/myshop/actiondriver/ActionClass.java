package com.myshop.actiondriver;
...
import com.myshop.actioninterface.ActionInterface;
import com.myshop.basepackage.BaseClass;

public abstract class ActionClass extends BaseClass implements ActionInterface{
	...
	public boolean switchToFrameByIndex(WebDriver driver,int index, Duration timeout) {
		boolean flag = false;
		try {
			new WebDriverWait(driver, timeout).until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//iframe")));
